...
<html lang="zh-cn">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="BookQuery.jsp">查找书籍</a></li>
    ...
    <form action = "bookquery.view" method=post>
    	</br>
        <div align="center" class="login-input-box">
            <span class="icon icon-user"></span>
            <input input type="text" name="bookname" placeholder="Please enter bookname">
        </div>
        </br></br>
